...
_REGISTRY = {
    ...
    "joint_power": energy_penalty.joint_power,
    ...
    "alive": posture.alive,
    "upward": posture.upward,
    "bad_orientation_penalty": posture.bad_orientation_penalty,
    "feet_air_time_multi": foot_contact_multi.feet_air_time_multi,
    "undesired_contacts": foot_contact_multi.undesired_contacts,
    "feet_air_time_lin_xy": foot_contact_multi.feet_air_time_lin_xy,
    "feet_air_time_ang_z_lite3": foot_contact_multi.feet_air_time_ang_z_lite3,
    "feet_contact_without_cmd": foot_contact_multi.feet_contact_without_cmd,
    "contact_forces": foot_contact_multi.contact_forces,
